...
class Panel(BasePage):
    ...
    def click_confirm_suggested_location(self):
        """
        Click 'Yes' button to confirm the suggested city,
    ...
    def is_confirm_loc_btn_visible(self):
        """
        Check if the "Confirm location" btn is visible,
    ...
    def get_loc_text(self):
        """
        Get the location text from the upper panel,
        :return: text
        """
    ...
    def click_choose_another_loc_btn(self):
        """
        Click "Choose another location" btn in the appeared location popup
        :return object of the page
        """
    ...
    def choose_location(self):
        """
        Click 'Choose another location' button, choosing 'Lviv' city as current city
    ...
    def get_loc_text_from_popup(self):
        """
        Get the location text from the location popup, after changing the location,
        :return: text
        """
    ...
    def choose_random_loc(self):
        """
        Click 'Choose another location' button, choosing random location from the list of locations
        :return: object of page
        """
        self.click_choose_another_loc_btn()
    ...
    def is_location_changed_popup_visible(self):
        """
        Check if the popup with changed location is visible,
        :return: True if the popup with chosen random location is visible
        """
        return self.is_element_visible(self.changed_loc_popup, 'Change location popup')

    def change_language(self):
        """
        Chang the language of the site to Ukrainian on the upper panel,
        :return: object of page
        """
    ...
    def add_lang_cookies(self):
        """
        Add cookies, which are responsible for choosing UKR language as the main language,
        :return: object of page
        """
    ...
    def is_login_btn_visible(self):
        ...
        :return: True, if login btn is visible, otherwise returns 'False'
        """
        return self.is_element_visible(self.login_btn_header, 'login button')
    ...
    def is_our_projects_visible(self):
        """
        Click on the 'Наши проекты' button, Checking the presence of "Our projects" block,
        :return: True, if "Our projects" block is visible
        """
        self.wait.until(EC.presence_of_element_located(self.our_projects_block)).click()
        return self.is_element_visible(self.drop_down_block_our_projects, 'Block "НАШИ ПРОЕКТЫ" drop down')
    ...
    def click_help_tab(self):
        """
        Open the "Help" tab on the upper panel and verifying that popup is opened,
        :return True if the popup is visible, otherwise return 'False'
        """
        self.wait.until(EC.visibility_of_element_located(self.help_tab)).click()
        return self.is_element_visible(self.help_popup, 'help popup')

    def click_certificate_tab(self):
        """
        Open the "Certificate" tab and verifying the popup is opened,
        :return True if the popup is visible, otherwise return 'False'
        """
        self.wait.until(EC.presence_of_element_located(self.certificate_tab)).click()
        return self.is_element_visible(self.certificate_popup, 'Certificate popup')
