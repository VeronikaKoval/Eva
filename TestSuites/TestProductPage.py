...
class TestProductPage(BaseTest):
    ...
    def test_country_filter(self):
        ...
        assert products_list.get_country_filter_attr() is True
    ...
    def test_cancellation_of_filter(self):
        ...
        time.sleep(2)
        products_list.apply_filter_country()
        assert 'filter/strana_proizvodstva-73217/' not in products_list.get_page_url()
    ...
    def test_name_filter(self):
        ...
        assert product_list.get_name_filter_attr() is True
    ...
    def test_sort_price_desc(self):
        ...
        assert '/?product_list_order=price' in product_list.get_page_url()
    ...
    def test_sort_asc(self):
        ...
        assert 'price&product_list_dir=asc' in product_list.get_page_url()
    ...
    def test_manual_price_filter(self):
        ...
        assert '102' in product_list.get_text_from_price_box()
