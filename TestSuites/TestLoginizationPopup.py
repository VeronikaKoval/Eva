...
class TestLoginization(BaseTest):
    ...
    def test_login(self):
        ...
        assert main_page.is_login_popup_present() is True
    ...
    def test_successful_authorization(self):
        ...
        assert 'Doctor' in main_page.get_account_name_text()
    ...
    def test_recovery_unsucc(self):
        ...
        assert 'Пожалуйста, введите правильный адрес электронной почты' in main_page.get_error_msg_recovery_wrong_email()
