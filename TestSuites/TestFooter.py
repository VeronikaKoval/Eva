...
class TestFooter(BaseTest):
    ...
    def test_open_Google(self):
        ...
        main_page = Footer()
        main_page.click_Google()
        # self.driver.window_handles()
        self.driver.switch_to.window(self.driver.window_handles[1])
        # time.sleep(2)
        assert 'plus.google.com/+EVAua500' in main_page.get_page_url(), 'URL doesnt match "plus.google.com"'
    ...
    #     main_page.click_FB()
    #     self.driver.switch_to.window(self.driver.window_handles[1])
    #     assert 'www.facebook.com/EVA.dp.ua' in main_page.get_page_url(), 'URL doesnt match "facebook.com/EVA.dp.ua"'
    ...
    def test_youtube(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[1])
        assert 'youtube.com/user/evadpua' in main_page.get_page_url(), 'URL doesnt match "youtube.com/user/evadpua"'
    ...
    def test_twitter(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[1])
        assert 'twitter.com/eva__ua' in main_page.get_page_url(), 'URL doesnt match "twitter.com/eva__ua" '

    # def test_viber(self):
    # """ Clicking on Viber link, verifying that it is opened in a new tab, checking page URL"""
    #     main_page = Footer()
    #     main_page.click_viber()
    #     self.driver.switch_to.window(self.driver.window_handles[1])
    #     assert 'chats.viber.com/evaua/en' in main_page.get_page_url(), 'URL doesnt match'
    ...
    def test_instagram(self):
        ...
        self.driver.switch_to.window(self.driver.window_handles[1])
        assert 'instagram.com/eva_ua/' in main_page.get_page_url(), 'URL doesnt match "instagram.com/eva_ua/" '
